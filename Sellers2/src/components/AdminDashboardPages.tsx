// This file contains the remaining admin dashboard page components
// Import and use these in the main AdminDashboard.tsx file

import { Save } from 'lucide-react';

export const ADMIN_PAGES_CONTENT = `
          {/* LOCATIONS PAGE */}
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center gap-6">
                    <Avatar className="h-24 w-24 bg-gradient-to-br from-blue-600 to-purple-600">
                      <AvatarFallback className="text-white text-3xl">SA</AvatarFallback>
                    </Avatar>
                    <div className="flex-1">
                      <h2 className="text-white text-2xl font-bold">Super Admin</h2>
                      <p className="text-gray-400">superadmin@handsandhope.com</p>
                      <Badge variant="default" className="mt-2">Super Administrator</Badge>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <Label className="text-gray-300">Full Name</Label>
                      <Input defaultValue="Super Admin" className="h-12 bg-gray-900 border-gray-700 text-white" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-gray-300">Email Address</Label>
                      <Input defaultValue="superadmin@handsandhope.com" className="h-12 bg-gray-900 border-gray-700 text-white" />
                    </div>
                  </div>

                  <div className="bg-orange-600/10 border border-orange-600/30 rounded-lg p-4">
                    <p className="text-sm text-orange-400">
                      <strong>Note:</strong> Password changes require additional verification for security purposes. 
